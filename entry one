...
This week I created a static website for a fictional startup call MakerMesh. I tried out a few options for hosting but settled on GitHub pages for the hosting and PHP Storm with some usage of Bootstrap for the creation of the site. 
...
Estimated Hours
I spent around 5 hours in total trying out a few different options for hosting, making the site, deploying it with GitHub pages and general troubleshooting issues I had getting it all to work how I wanted it to.
